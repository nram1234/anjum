...
ifhaveinternetornot()async{
  if (!Get.find<NetWorkController>()
      .connectionStatus
      .value) {
    Get_first_step_json get_first_step_json=await Get_first_step_json.fromJson(box.read('get_first_step'))  ;
    ...
    //===========================================================
    Get_second_step1_json get_second_step1=await Get_second_step1_json.fromJson(box.read('get_second_step1'))  ;
    Get.find<AllCustomersControllers>()
        .updateallCustomers(get_second_step1.result.allCustomers);
    //===========================================================
    Get_second_step2_json get_second_step2=await Get_second_step2_json.fromJson(box.read('get_second_step2'))  ;
    Get.find<PriceListsInfoController>().updatepriceListMap(priceListsInfo:get_second_step2.result.priceListsInfo );
    //===========================================================
    Get_second_step3_json get_second_step3=await Get_second_step3_json.fromJson(box.read('get_second_step3'))  ;
    get_second_step3.result.itemUnits;

     Get.find<ItemUnitsController>().updateitemUnitstMap(list: get_second_step3.result.itemUnits);

    //===========================================================
    Get_second_step1_json get_second_step_json=await Get_second_step1_json.fromJson(box.read('get_second_step1'))  ;
    Get.find<AllCustomersControllers>()
        .updateallCustomers(get_second_step_json.result.allCustomers);
    //===========================================================
    Get_third_step_json get_third_step_json=await Get_third_step_json.fromJson(box.read('get_third_step'))  ;
    ...
    //===========================================================
    Get_fourth_step_json get_fourth_step_json=await Get_fourth_step_json.fromJson(box.read('get_fourth_step'))  ;
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,mainAxisSize: MainAxisSize.max,
                children: [
                  itemInList(
                      ...
                      fun: () async{
                        _allNetworking.get_first_step(user_id: userId).then((value) async {
...
Get.find<All_routesController>()
                  ...
                  itemInList(
                      ...
                      titl: 'customers',
                      fun: () {
                        _allNetworking.get_second_step1(user_id: userId).then((value) async {
                  ...
                  itemInList(
                      ...
                      titl: 'price list',
                      fun: () {
                        _allNetworking.get_second_step2(user_id: userId).then((value) async {
                          value.result.priceListsInfo;
 Get.find<PriceListsInfoController>().updatepriceListMap(priceListsInfo:value.result.priceListsInfo );
                  ...
                  itemInList(
                      ...
                      titl: 'items unit',
                      fun: () {
                        _allNetworking.get_second_step3(user_id: userId).then((value) async {
                          value.result.itemUnits;
value.result.itemUnits;
                          Get.find<ItemUnitsController>().updateitemUnitstMap(list: value.result.itemUnits);
                  ...
                  itemInList(
                      ...
                      fun: () {
                        _allNetworking.get_third_step(user_id: userId).then((value) async {
                  ...
                  itemInList(
                      ...
                      fun: () {
                        _allNetworking.get_fourth_step(user_id: userId).then((value) async {
                  ...
                  itemInList(
                      ...
                      titl: 'items quantity',
                      fun: () {
                        _allNetworking.get_Fifth_step(user_id: userId).then((value) async {
        ...
        children: [
          InkWell(
            ...
            child: Icon(
              ...
              color: lod ? Colors.green : Colors.grey,size: 50,
            ),
          ),
          const SizedBox(
            width: 16,
